...
script.href = "/Story-Rocks-style.css";
...
this.Story = function() {
    ...
    stories.id = "stories"
    document.getElementsByClassName("storyrocks-collection-row")[0].appendChild(stories);
...
function close() {
    document.getElementById("main-header").style.display = "revert";
    document.getElementById("top-header").style.display = "revert";
    //Unblock scroll
